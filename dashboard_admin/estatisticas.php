        ...
        <aside class="main-sidebar">
            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="active"><a href="estatisticas.php"><i class="fa fa-line-chart"></i>
                            <span>Estatisticas</span></a></li>
                    <li class="treeview">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active"><a href="#"><i class="fa fa-line-chart"></i> Estatisticas</a></li>
            </ol>
        </section>
