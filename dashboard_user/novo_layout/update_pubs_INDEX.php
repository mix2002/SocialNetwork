...
$id = $_SESSION['id'];
$query_util = mysqli_query($lig, "SELECT * FROM `posts_historico` LEFT JOIN `post_likes` ON `posts_historico`.`post_id`=`post_likes`.`id_post` ORDER BY `post_id` DESC LIMIT 3");
