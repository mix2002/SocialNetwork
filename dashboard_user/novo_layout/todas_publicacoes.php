...
<main role="main" class="container">
    ...
    <div class="my-3 p-3 bg-white rounded box-shadow">
        <h6 class="border-bottom border-gray pb-2 mb-0">Todas as Publicações</h6>
        ...
        <div class="row pubs" id="artigo-<?php echo $artigo->post_id ?>">
            <div class="col col-12 py-1 my-3 text-white-50  rounded box-shadow"
                ...
                <div class="post_footer">
                    ...
                    ?>
                    <small style="color:#109935; font-size: 17px; padding-left: 1%;"><i
                                class="fa fa-thumbs-up"><b> <?php echo $likes_counter; ?></b></i></small>
                    <br>
    ...
    $(document).ready(function () {
        ...
        $('#postagem-submit').click(function () {
            ...
            $.post("criar_post_pubs.php", {
                ...
                console.log("Success");
                $("#mensagem").val("");
                $('.pubs').load('update_pubs_todas.php').fadeIn("Slow");
            });
        });
    });
</script>
